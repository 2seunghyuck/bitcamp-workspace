...
public class RequestMappingListener implements ApplicationContextListener {
  ...
  public void contextInitialized(Map<String,Object> context) {
    ...
    context.put("add", new TodoAddCommand(todoList));
    context.put("delete", new TodoDeleteCommand(todoList));
    context.put("detail", new TodoDetailCommand(todoList));
    context.put("list", new TodoListCommand(todoList));
    context.put("update", new TodoUpdateCommand(todoList,memberListCommand));
