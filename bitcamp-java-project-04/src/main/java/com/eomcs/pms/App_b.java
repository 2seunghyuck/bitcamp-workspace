...
public class App_b {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("---------------------");
    System.out.printf("%d, %s, %s, %s, %s, %s, %s%n", no1, name1, email1, password1, photo1, tell1,
        now1.toString());
    if (count > 1) {
      System.out.printf("%d, %s, %s, %s, %s, %s, %s%n", no2, name2, email2, password2, photo2, tell2,
          now2.toString());
      if (count > 2) {
        System.out.printf("%d, %s, %s, %s, %s, %s, %s%n", no3, name3, email3, password3, photo3, tell3,
            now3.toString());
        if (count > 3) {
          System.out.printf("%d, %s, %s, %s, %s, %s, %s%n", no4, name4, email4, password4, photo4, tell4,
              now4.toString());
          if (count > 4) {
            System.out.printf("%d, %s, %s, %s, %s, %s, %s%n", no5, name5, email5, password5, photo5, tell5,
                now5.toString());
          }
        }
      }
