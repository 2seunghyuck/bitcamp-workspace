...
<body>
  ...
  <div class="col-sm-6">
              ...
              <div style="margin-bottom: 10px;">
                <input type="text" class="text-center" name="postNo" value='${user.postNo}'
                  placeholder="우편번호" style="width: 200px"> <input
                  type="button" onclick="execPostCode()" value="찾기"
                  style="width: 100px"><br>
              </div>
              <div style="margin-bottom: 10px;">
                <input type="text" class="text-center" id="address" name="address" 
                value="<c:if test=" ${not empty user.address}">${user.address}</c:if>"
                  placeholder="주소" style="width: 300px"> <input
                  type="text" class="text-center" id="detailAddress" name="detailAddress" 
