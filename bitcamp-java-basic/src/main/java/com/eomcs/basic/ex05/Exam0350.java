...
public class Exam0350 {
  public static void main(String[] args) {
    ...
    System.out.println(a ^ b); //둘 다를때 1 출력.
    // a = 0000 0000 0000 0000 0000 0000 0110 1100
    // b = 0000 0000 0000 0000 0000 0000 0101 0101
    // --------------------------------------------
...
//          빛이 없는점에는 빛을 넣는다.
// => 다음과 같이 흑색의 한 점이 있다.
//   00000000 00000000 00000000 (변경전 색)검정색
// ~                              0을 1로, 1을 0으로 바꾼다.
// -------------------------------
...
// 비트 연산 활용 예4: 크로마키 활용
// => 특정 색상만 제거하기.
// => 방법:  ^연산자 사용하여, 특정색상만 제거할 수 있다.
// => 다음과 같이 특정한 비트가 있다.
//    11000010 11100100 00100100 (예제 색상)
//  ^ 11000010 11100100 00100100 (제거하려는 색) 
//  -------------------------------
//    00000000 00000000 00000000 (출력 결과)
// 한점에 대해 연산한 출력결과가 0이면 해당 점의 색상을 제거하고, 0이 아니라면 원래색을사용한다.
//
