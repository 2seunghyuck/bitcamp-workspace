...
public class Exam0210 {
  ...
  // 만약 Wrapper클래스가 없다면 다음과같이 정수, 부동소수점, 논리값을 받는 메서드를
  // 따로따로 정의해야 한다.
  // => 이런 불편함을 방지하고자 Wrapper클래스가 생겼다.
  // => 즉 Primitive type을 객체와 함께 다룰수 있도록 만든 문법이다.

  void m2(int value) { // byte, short, int ,long
    System.out.printf("value = %s\n", value);
  }
