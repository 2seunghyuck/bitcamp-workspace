...
public class Exam0154 {
  public static void main(String[] args) {
    ...
    //map.put(str,  new Student("김", 50, true)); key 를 integer로 지정해서 String을 키로 사용할 수 없다.
    ...
    // => key 값으로 int를 넘겨준다면,
    //    컴파일러가 내부적으로 auto-boxing을 수행하여 Integer 객체를 만든다.
    //    그리고 그 객체를 넘겨주는 것이다.
    map.put(104/* new Integer(104) <- 컴파일러가 고쳐줌*/ , new Student("안중근", 24, true));
