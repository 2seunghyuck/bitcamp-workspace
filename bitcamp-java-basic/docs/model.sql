...
CREATE TABLE lms_stud (
  ...
  work  INTEGER     NULL     COMMENT '재직여부', -- 재직여부
  schno INTEGER     NOT NULL COMMENT '학교번호', -- 학교번호
  elno  INTEGER     NOT NULL COMMENT '학력번호', -- 학력번호
  majno INTEGER     NOT NULL COMMENT '전공번호', -- 전공번호
  banno INTEGER     NULL     COMMENT '은행번호', -- 은행번호
  accnt VARCHAR(20) NULL     COMMENT '계좌번호' -- 계좌번호
)
COMMENT '학생';
...
CREATE TABLE lms_appl (
  ...
  sno  INTEGER  NOT NULL COMMENT '학생번호', -- 학생번호
  lno  INTEGER  NOT NULL COMMENT '교육과정 번호', -- 교육과정 번호
...
CREATE TABLE lms_lect (
  ...
  hrs     DATETIME     NOT NULL COMMENT '총강의시간', -- 총강의시간
...
ALTER TABLE lms_lect
  MODIFY COLUMN lno INTEGER NOT NULL AUTO_INCREMENT COMMENT '교육과정 번호';
...
CREATE TABLE lms_room_photo (
  rpno     INTEGER      NOT NULL COMMENT '교실사진 번호', -- 교실사진 번호
...
ALTER TABLE lms_room_photo
  MODIFY COLUMN rpno INTEGER NOT NULL AUTO_INCREMENT COMMENT '교실사진 번호';
